...
- **تست خودکار آفلاین** با ۴۷ بررسی (`tools/selftest.php`) و بازرسی چیدمان (`tools/layout-check.php`).
...
- ایموجی پریمیوم فقط وقتی در کانال دیده می‌شود که ربات اجازه‌ی استفاده از آن را داشته باشد؛ در غیر این صورت تلگرام همان ایموجی جایگزین را نشان می‌دهد.
